    ...
    <div>
        <div class="-mx-6 px-6 py-4">
            <a href="{{ route('dashboard') }}" title="home">
                <img src="{{ asset('assets/img/Logo-PPK-HIMAFA.png') }}" class="w-32" alt="logo" />
            </a>
        </div>
        ...
        <ul class="mt-8 space-y-2 tracking-wide">
            <li>
                <a href="{{ route('dashboard') }}" aria-label="dashboard"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-speedometer2 h-5 w-5"
                        viewBox="0 0 20 20">
                        <path class="fill-current text-gray-600 group-hover:text-green-600"
            ...
            <li>
                <a href="{{ route('categories.index') }}"
                    class="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-hdd-stack h-5 w-5"
                        viewBox="0 0 20 20">
                        <path class="fill-current text-gray-600 group-hover:text-green-600"
                    ...
                    <span class="group-hover:text-green-700">Kategori</span>
                </a>
            </li>
            <li>
                <a href="{{ route('plants.index') }}"
                    class="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-flower1 h-5 w-5"
                        viewBox="0 0 20 20">
                        <path class="fill-current text-gray-600 group-hover:text-green-600"
                    ...
                    <span class="group-hover:text-green-700">Tanaman</span>
                </a>
            </li>
            <li>
                <a href="{{ route('products.index') }}"
                    class="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-box-seam h-5 w-5"
                        viewBox="0 0 20 20">
                        <path class="fill-current text-gray-600 group-hover:text-green-600"
            ...
            <li>
                <a href="{{ route('spots.index') }}"
                    class="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-geo-fill h-5 w-5"
                        viewBox="0 0 20 20">
                        <path class="fill-current text-gray-600 group-hover:text-green-600" fill-rule="evenodd"
                    ...
                    <span class="group-hover:text-green-700">Lokasi</span>
                </a>
            </li>
        </ul>
    </div>
